...
export class News extends Component {
    ...
    constructor(props) {
        ...
        document.title = `${this.capitalizeFirstLetter(this.props.category)}-KhabreSabki`;
    }
    ...
    render() {
        return (
            <>
                <h1 className="text-center" style={{ margin: '40px 0px' }}>KhabreSabki-Top {this.capitalizeFirstLetter(this.props.category)} headlines</h1>
